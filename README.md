...
- LLM integrations, RAG prototypes, and evaluation workflows
- Backend APIs and real-time systems used by real users
- Data ingestion, automation, and reliability-first engineering
...
Databricks, Spark, Airflow, dbt  
AWS, Azure  
FastAPI, Flask  
LLMs, RAG, MLOps patterns
